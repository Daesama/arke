...
export function CrearClient() {
  ...
  // Estado de las 3 zonas (archivo, preview, transform, quitar fondo).
  // El mismo hook lo usa el constructor de camisas de /admin/catalogo.
  const {
    zones,
    previews,
    activeZones,
        ...
        <div className="absolute inset-0 z-50 flex items-center justify-center bg-void/70 backdrop-blur-xl">
          <div className="gradient-border mx-4 w-full max-w-sm rounded-2xl bg-surface/50 p-8 text-center shadow-2xl shadow-void/60 backdrop-blur-xl">
            ...
            <div className="mt-6 flex flex-col gap-3">
              ...
              <Link href={`/auth/registro?redirect=${encodeURIComponent(returnPath)}`}>
